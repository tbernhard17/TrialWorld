...
{
    /// <summary>
    /// Implementation of the AssemblyAI direct API service for audio transcription.
    /// This service provides a production-ready integration with the AssemblyAI REST API.
    /// </summary>
    public class AssemblyAIDirectApiService : IAssemblyAIDirectApiService, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssemblyAIDirectApiService"/> class.
        /// </summary>
        /// <param name="httpClient">The HTTP client for making API requests.</param>
        /// <param name="logger">The logger for recording diagnostic information.</param>
        /// <param name="options">The configuration options for the service.</param>
        /// <param name="diagnosticsService">Optional diagnostics service for performance monitoring.</param>
            ...
            DiagnosticsService? diagnosticsService = null)
        {
            ...
            _jsonOptions = new JsonSerializerOptions
            {
                ...
                WriteIndented = _options.EnableDetailedLogging
            };

            _logger.LogInformation("AssemblyAI Direct API Service initialized with base URL: {BaseUrl}", _options.BaseUrl);
        }
        ...
        private void ThrowIfDisposed()
        {
            if (_disposed)
            {
                throw new ObjectDisposedException(nameof(AssemblyAIDirectApiService));
            }
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                // We don't dispose _httpClient here because it's managed by HttpClientFactory
                // and will be disposed when the application shuts down
                _logger.LogDebug("AssemblyAI Direct API Service disposed");
            }
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="AssemblyAIDirectApiService"/> class.
        /// </summary>
        ~AssemblyAIDirectApiService()
        {
            Dispose(false);
        }
